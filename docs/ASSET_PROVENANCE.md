...
| --- | --- | --- |
| Three-zone low-poly environment | `assets/scene_source.json` | Original scene composition; expanded offline into host-test C++ data and independent `romfs/zones/*.bin` runtime blobs |
