...
| M2 Connected slice | `2b210e1` | Interior reveal, vista NPC and masked fog transition | Visual handoff timing is unverified on device | Visible/culled-object and measured per-zone linear-memory peaks implemented | Door handoff and outdoor reveal |
